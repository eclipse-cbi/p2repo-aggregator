...
/**
 * This is the action bar contributor for the Analyzer model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnalyzerActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			AggregationAnalyzerEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			AggregationAnalyzerEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	 ...
	 * @generated
	 */
	public AnalyzerActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("analyzer-settings"));
		toolBarManager.add(new Separator("analyzer-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				AggregationAnalyzerEditorPlugin.INSTANCE.getString("_UI_AnalyzerEditor_menu"),
				"org.eclipse.cbi.p2repo.aggregator.analyzerMenuID");
		...
		createSiblingMenuManager = new MenuManager(
				AggregationAnalyzerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
