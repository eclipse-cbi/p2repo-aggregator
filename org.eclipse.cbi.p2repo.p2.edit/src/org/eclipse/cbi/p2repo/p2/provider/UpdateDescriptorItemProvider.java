 ...
 * {@link org.eclipse.cbi.p2repo.p2.UpdateDescriptor} object. <!--
...
public class UpdateDescriptorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IUpdateDescriptor_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IUpdateDescriptor_description_feature",
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IUpdateDescriptor_location_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IUpdateDescriptor_location_feature",
								"_UI_IUpdateDescriptor_type"),
	...
	protected void addSeverityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IUpdateDescriptor_severity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IUpdateDescriptor_severity_feature",
								"_UI_IUpdateDescriptor_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_UpdateDescriptor_type")
