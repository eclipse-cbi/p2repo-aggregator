...
/**
 * This is the item provider adapter for a {@link org.eclipse.cbi.p2repo.p2.Copyright} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CopyrightItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ICopyright_body_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ICopyright_body_feature",
								"_UI_ICopyright_type"),
						P2Package.Literals.ICOPYRIGHT__BODY, true, true, false,
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ICopyright_location_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ICopyright_location_feature",
								"_UI_ICopyright_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Copyright_type")
