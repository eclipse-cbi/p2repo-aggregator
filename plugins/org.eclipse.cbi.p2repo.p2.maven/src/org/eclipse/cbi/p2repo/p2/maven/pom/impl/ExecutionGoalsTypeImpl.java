...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Execution Goals Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class ExecutionGoalsTypeImpl extends MinimalEObjectImpl.Container implements ExecutionGoalsType {
	/**
	...
	public EList<String> getGoal() {
		if (goal == null) {
			goal = new EDataTypeEList<>(String.class, this, PomPackage.EXECUTION_GOALS_TYPE__GOAL);
		}
		return goal;
	}
