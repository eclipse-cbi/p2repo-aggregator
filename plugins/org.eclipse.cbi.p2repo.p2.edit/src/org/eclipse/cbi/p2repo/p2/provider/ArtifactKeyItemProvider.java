...
/**
 * This is the item provider adapter for a {@link org.eclipse.cbi.p2repo.p2.ArtifactKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactKeyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addClassifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IArtifactKey_classifier_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IArtifactKey_classifier_feature",
								"_UI_IArtifactKey_type"),
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IArtifactKey_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IArtifactKey_id_feature",
								"_UI_IArtifactKey_type"),
						P2Package.Literals.IARTIFACT_KEY__ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IArtifactKey_version_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IArtifactKey_version_feature",
								"_UI_IArtifactKey_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ArtifactKey_type")
