...
public interface Scm extends EObject {
	 ...
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	 *        extendedMetaData="kind='element' name='developerConnection'
	 *        namespace='##targetNamespace'"
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Tag</b></em>' attribute. The default
	 * value is <code>"HEAD"</code>. <!-- begin-user-doc --> <!-- end-user-doc
	 * --> <!-- begin-model-doc --> 4.0.0
	 *
	 ...
	 * @model default="HEAD" unsettable="true"
