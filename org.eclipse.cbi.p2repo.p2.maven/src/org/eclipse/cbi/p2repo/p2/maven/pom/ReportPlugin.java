...
public interface ReportPlugin extends EObject {
	 ...
	 * begin-model-doc --> 4.0.0 The configuration of the reporting plugin. <!--
	 * end-model-doc -->
	 *
	 * @return the value of the '<em>Configuration</em>' containment reference.
	 * @see #setConfiguration(ConfigurationType)
	 * @see org.eclipse.cbi.p2repo.p2.maven.pom.PomPackage#getReportPlugin_Configuration()
	 ...
	 * @see org.eclipse.cbi.p2repo.p2.maven.pom.PomPackage#getReportPlugin_GroupId()
	 ...
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
	 * begin-model-doc --> 4.0.0 Multiple specifications of a set of reports,
	 * each having (possibly) different configuration. This is the reporting
	 * parallel to an &lt;code&gt;execution&lt;/code&gt; in the build. <!--
	 * end-model-doc -->
	 *
	 * @return the value of the '<em>Report Sets</em>' containment reference.
	 * @see #setReportSets(ReportSetsType)
	 * @see org.eclipse.cbi.p2repo.p2.maven.pom.PomPackage#getReportPlugin_ReportSets()
	 * @model containment="true" extendedMetaData="kind='element'
	 *        name='reportSets' namespace='##targetNamespace'"
	 * @generated
	 */
	 ...
	 * @see org.eclipse.cbi.p2repo.p2.maven.pom.PomPackage#getReportPlugin_Version()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	 ...
	 * '{@link org.eclipse.cbi.p2repo.p2.maven.pom.ReportPlugin#getGroupId
	...
	/**
	 * Sets the value of the
	 * '{@link org.eclipse.cbi.p2repo.p2.maven.pom.ReportPlugin#getInherited
	...
	/**
	 * Sets the value of the
	 * '{@link org.eclipse.cbi.p2repo.p2.maven.pom.ReportPlugin#getVersion
