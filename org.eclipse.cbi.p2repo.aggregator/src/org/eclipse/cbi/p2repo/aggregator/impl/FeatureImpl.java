 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cbi.p2repo.aggregator.impl.FeatureImpl#getCategories <em>Categories</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureImpl extends MappedUnitImpl implements Feature {
	...
	public EList<CustomCategory> getCategories() {
		if (categories == null) {
			categories = new EObjectWithInverseResolvingEList.ManyInverse<>(CustomCategory.class, this,
